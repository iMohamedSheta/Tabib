...
<div class="md:container py-6 mx-auto grid my-6 text-gray-700 dark:text-gray-200">
    <x-main.head wire:ignore :icon="asset('images/clinics/icon.png')" >
        ...
        <x-slot name="body">
            العيادات، التي تمثل الفروع المختلفة و العيادة الرئيسية، تتيح لك هذه الصفحة إدارة جميع العيادات المتاحة في النظام. يمكنك من خلالها إضافة فروع جديدة، تعديل معلومات الفروع الحالية، أو حذف الفروع غير النشطة. لكل فرع سجل خاص يمكّنك من تتبع نشاطه، وحالات المرضى، ومعلومات الأطباء العاملين به، مما يسهل إدارة وتنظيم العمل في مختلف الفروع بشكل فعّال.
        </x-slot>
    </x-main.head>
    <div
