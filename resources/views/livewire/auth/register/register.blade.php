            ...
            @if ($step == 1)
                <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                    <div class="w-full">
                        ...
                        <x-form.input-text x-data x-init="$el.focus()" id="name" label="انشاء العيادة"
                            autocomplete="off" labelClass="text-lg" placeholder='اسم العيادة مثل : عيادة وادي النيل'
                            withError="name" wire:model="name">
                        </x-form.input-text>
                        ...
                        <hr class="my-8" />
                        <x-form.link href="{{ route('socialite.google.redirect') }}" class="text-sm">
                        ...
                        <x-form.link href="{{ route('socialite.facebook.redirect') }}" class="mt-4 text-sm">
                            ...
                            function openFacebookLogin() {
                                ...
                                window.addEventListener('message', (event) => {
                                    if (event.data === 'socialite-login-success') {
                                        location.reload();
                                    }elseif (event.data === 'socialite-redirect-') {
