<div >
    <x-modals.modal @keydown.escape.window="show = false">
        <x-slot name="title">
            تعديل طبيب
        </x-slot>
        ...
        <x-slot name="content">
            ...
            <div class="flex flex-wrap">
                ...
                <div class="mt-6 w-full md:w-1/2 px-2">
                    ...
                    <x-select.select label="اختيار العيادة" withError="clinic_id" :items="$clinics" :items="$clinics"
        ...
        <x-slot name="footer">
            <button class="mx-2 btn-dark text-sm " wire:click="addDoctor" wire:loading.attr="disabled">
                {{ __('حفظ') }}
            </button>
