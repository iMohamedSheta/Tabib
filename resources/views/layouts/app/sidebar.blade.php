<!-- Desktop sidebar -->
<aside class="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 shadow-md dark:shadow-slate-300 md:block flex-shrink-0">
    <div class="py-4 text-gray-500 dark:text-gray-400">
        ...
        <ul class="mt-6">
            ...
            <li class="relative px-6 py-3">
                <!-- Add this classes to an active anchor (a tag) -->
                <!-- text-gray-800 dark:text-gray-100 -->
                @isRoute('app.admin.clinic.index')
                <span
                    class="absolute inset-y-0 right-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg"
                    aria-hidden="true"
                ></span>
                @endIsRoute
                <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                    href="{{ route('app.admin.clinic.index') }}">
