<!-- Desktop sidebar -->
<aside
    class="z-20 hidden m-4 rounded-xl w-64 h-[97vh] overflow-y-auto opacity-90  bg-purple-800  dark:bg-c-gray-800 shadow-lg dark:shadow-lg md:block flex-shrink-0
 scrollbar-thin scrollbar-track-purple-800 scrollbar-thumb-purple-500 dark:scrollbar-thumb-gray-600 dark:scrollbar-track-gray-800"
    style="z-index: 0">
    <div class="pb-4 text-gray-500 dark:text-gray-400">
        <div class="text-center bg-c-gray-800 dark:bg-purple-800  pb-2 pt-4 rounded">
