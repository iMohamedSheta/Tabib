    ...
    <td class="flex items-center justify-center group my-4" x-data="actions()"
        ...
        <div class="bg-c-gray-700 rounded-full">
            <div class="flex  items-center justify-center  ">
                ...
                <!-- Dropdown Menu -->
                <div x-show="showDropdown" style="display: none;" @click.away="showDropdown = false"
                    ...
                    <div
                        class="absolute  @if (!$isTable) right-[-10px] top-[-10rem] @else right-[-10px] top-[20px] @endif dark:opacity-90 w-56 p-2 mt-2 space-y-2 text-purple-100 bg-purple-600 opacity-90 border border-gray-100 rounded-md shadow-md dark:border-gray-700 dark:text-gray-300 dark:bg-gray-700">
                        {{ $slot }}
                    </div>
                </div>
            </div>
