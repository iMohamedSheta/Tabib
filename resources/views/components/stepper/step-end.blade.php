...
<li
    class="relative flex-1 after:content-['']  after:w-0.5 after:h-full  {{ $active ? 'after:bg-purple-700' : 'after:bg-gray-200' }} after:inline-block after:absolute after:-bottom-12 after:left-1/2 shadow-lg">
