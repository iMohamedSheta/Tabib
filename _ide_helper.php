...
namespace Illuminate\Database\Query {
    ...
    class Builder {
         ...
         * 
         *
         * @see \App\Macros\QueryBuilderMacro::registerLikeIn()
         * @param array $fields
         * @param mixed $value
         * @return object 
         * @static 
         */
        public static function likeIn($fields, $value)
        {
            return \Illuminate\Database\Query\Builder::likeIn($fields, $value);
        }

        /**
         * 
         *
         * @see \App\Macros\QueryBuilderMacro::registerIsPatient()
         * @return object 
         * @static 
         */
        public static function isPatient()
        {
            return \Illuminate\Database\Query\Builder::isPatient();
        }

        /**
         * 
         *
         * @see \App\Macros\QueryBuilderMacro::registerSameOrganization()
         * @return object 
         * @static 
         */
        public static function sameOrganization()
        {
            return \Illuminate\Database\Query\Builder::sameOrganization();
        }

        /**
         * 
         *
         * @see \App\Macros\QueryBuilderMacro::registerNotDeleted()
         * @param mixed $isDeleted
         * @return object 
         * @static 
         */
        public static function notDeleted($isDeleted = true)
        {
            return \Illuminate\Database\Query\Builder::notDeleted($isDeleted);
        }

        /**
         * 
         *
         * @see \App\Macros\QueryBuilderMacro::registerOrLikeUserFullName()
         * @param mixed $value
         * @return object 
         * @static 
         */
        public static function orLikeUserFullName($value)
        {
            return \Illuminate\Database\Query\Builder::orLikeUserFullName($value);
        }
