...
enum AiModelEnum: string
{
    ...
    case TEXT_EMBEDDING_004 = 'text-embedding-004';
    case TEXT_EMBEDDING_005 = 'text-embedding-005';
    case TEXT_MULTILINGUAL_EMBEDDING_002 = 'text-multilingual-embedding-002';
